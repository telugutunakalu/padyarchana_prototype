...
_CLASSICAL = {
    ...
    "బిరుదరాజ శేషాద్రిరాజు":  (None, None, "క్రీ.శ 19వ శతాబ్దం (1893 ప్రచురణ)"),
    # Confirmed PD by author / publication-era inference:
    "కాకమాని మూర్తి":          (None, None, "క్రీ.శ 19వ శతాబ్దం (1894 ప్రచురణ)"),
    "మండపాక పార్వతీశ్వర శాస్త్రి": (None, None, "క్రీ.శ 19వ శతాబ్దం (1896 ప్రచురణ)"),
    "పూసపాటి తమ్మభూపాలుడు":   (None, None, "క్రీ.శ 19వ శతాబ్దం (1893 ప్రచురణ)"),
    "శ్రీమతి కామేశ్వరమ్మ":     (None, None, "20వ శతాబ్దం"),
}
...
_PD_BY_DATE = {
    ...
    "గోపీనాథము వేంకటకవి":      (1820, 1892, "క్రీ.శ 1820 – 1892"),
    "గోపినాథ వేంకటకవి":        (1820, 1892, "క్రీ.శ 1820 – 1892"),  # alt spelling — consolidated into గోపీనాథము
}
