...
MARKERS: dict[str, str] = {
    ...
    "మ": "మత్తేభవిక్రీడితము",
    "వ": "వచనము",
    # rarer vṛttas — appear by full name as inline labels in some prabandhas
    "మహాస్రగ్ధర": "మహాస్రగ్ధర",
    "స్రగ్ధర": "స్రగ్ధర",
    "స్రగ్విణి": "స్రగ్విణి",
    "ఉత్సాహ": "ఉత్సాహము",
    "పంచచామరము": "పంచచామరము",
    ...
    "లయగ్రాహి": "లయగ్రాహి",
    "మాలిని": "మాలిని",
    "భుజంగప్రయాతము": "భుజంగప్రయాతము",
    "తోటకము": "తోటకము",
    "మణిగణనికరము": "మణిగణనికరము",
    "కవిరాజవిరాజితము": "కవిరాజవిరాజితము",
}
