...
sentence_csv_file = os.path.join(base_dir, "SwaraSangraha/yogasutra/sentence_data.csv")
word_csv_file = os.path.join(base_dir, "SwaraSangraha/yogasutra/word_data.csv")
audio_directory = os.path.join(base_dir, "SwaraSangraha/yogasutra/audio")
