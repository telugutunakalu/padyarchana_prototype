...
sentence_csv_file = os.path.join(base_dir, "SwaraSangraha/tarkasangraha2/sentence_data.csv")
word_csv_file = os.path.join(base_dir, "SwaraSangraha/tarkasangraha2/word_data.csv")
audio_directory = os.path.join(base_dir, "SwaraSangraha/tarkasangraha2/audio")
